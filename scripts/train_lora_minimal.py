...
DATA_PATH = "/home/security-ft/code-security-ft/datasets/detection_tasks.jsonl"
OUTPUT_DIR = "/home/security-ft/code-security-ft/outputs/auditor_lora"
MERGED_DIR = "/home/security-ft/code-security-ft/models/auditor_merged"
...
def main():
    ...
    print("📦 Loading base model (fp16 for ROCm stability)...")
    ...
    def format_fn(examples):
        ...
        # FIX: static padding + explicit labels copy
        tok = tokenizer(texts, truncation=True, max_length=4096, padding="max_length")
    ...
    args = TrainingArguments(
        ...
        save_total_limit=2,
        report_to="none",
        dataloader_num_workers=0,      # FIX: ROCm fork safety
        remove_unused_columns=False,   # FIX: keep labels
